...
import { getAdminCreds, setAdminCreds } from '../services/auth.js';
...
export function renderConfig(root) {
  ...
  root.innerHTML = `
    ...
    <div class="card">
      ...
      <p style="font-size:.76rem;color:var(--txt2);margin:.6rem 0 0">Los docentes ya no usan una contraseña compartida — cada uno tiene la suya propia, asignada en <b>Docentes</b>. Solo quien esté registrado ahí puede entrar.</p>
    </div>
