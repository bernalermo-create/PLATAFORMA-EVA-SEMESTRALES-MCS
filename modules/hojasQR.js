...
function generarCuadernillo(root, evaluacionIds, admin) {
  ...
  out.innerHTML = admin
    ? `<div class="no-print" style="margin:1rem 0"><button class="btn sec" onclick="window.print()">🖨 Imprimir cuadernillo</button></div>`
    : `<div class="no-print" style="margin:1rem 0"><span style="font-size:.8rem;color:var(--txt2)">Vista previa — solo el administrador puede imprimir.</span></div>`;
